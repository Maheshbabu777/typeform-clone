  ...
  if (!form) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-background">
        <h2 className="text-xl font-medium text-foreground">Form not found</h2>
        <button
          onClick={() => router.push("/")}
    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <header className="flex h-16 items-center justify-between border-b border-border bg-card px-6 text-card-foreground shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <h1 className="max-w-[100px] sm:max-w-sm truncate text-lg font-medium text-foreground">
            {form.title}
          </h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            download
            className="flex items-center gap-2 rounded-md border border-border bg-card px-3 sm:px-4 py-2 text-sm font-medium text-foreground shadow-sm transition-colors hover:bg-muted"
          >
